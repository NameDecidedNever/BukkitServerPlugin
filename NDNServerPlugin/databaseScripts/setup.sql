...
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('MOB_KILL_FACTOR', '0.0005');
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('MOB_MONEY_PERCENT_TO_TOWN_OWNER', '1');
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('MIN_SPAWN_FREE_TP', '50');
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('COST_PER_BLOCK_TRAVEL_SPAWN_TP', '0.03');
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('COST_TO_STOP_RAIN', '20');
...
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('TOWN_FOUNDING_COST', '750');
INSERT INTO `minecraft-data`.`constants` (`name`, `value`) VALUES ('TOWN_DEFAULT_RADIUS', '100');
